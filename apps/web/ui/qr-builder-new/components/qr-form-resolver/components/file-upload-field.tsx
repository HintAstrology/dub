...
import { FileUpload } from "@/ui/qr-builder-new/components/file-upload";
import { FileUploadDropzone } from "@/ui/qr-builder-new/components/file-upload/dropzone";
import { FileUploadItem } from "@/ui/qr-builder-new/components/file-upload/item";
import { FileUploadItemDelete } from "@/ui/qr-builder-new/components/file-upload/item-delete";
import { FileUploadItemMetadata } from "@/ui/qr-builder-new/components/file-upload/item-metadata";
import { FileUploadItemPreview } from "@/ui/qr-builder-new/components/file-upload/item-preview";
import { FileUploadItemProgress } from "@/ui/qr-builder-new/components/file-upload/item-progress";
import { FileUploadList } from "@/ui/qr-builder-new/components/file-upload/list";
...
export const FileUploadField = ({
  ...
  const formatAcceptTypes = (accept: string) => {
    ...
    return accept
      .split(",")
      .map((type) =>
        type.trim().replace("application/", "").replace("/*", "").toUpperCase(),
      )
      .join(", ");
  };
