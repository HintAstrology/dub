...
export const CustomerSupport: FC<Readonly<ICustomerSupportProps>> = ({
  ...
  return (
    <Link
      className="bg-white border-none hover:border-primary hover:bg-primary/5 group inline-flex items-center gap-3 rounded-2xl border px-4 py-3 text-sm font-medium transition-all"
      href="/help"
      target="_blank"
