...
export const CustomerSupport: FC<Readonly<ICustomerSupportProps>> = ({
  ...
  return (
    <Link
      className="bg-white border border-gray-100 hover:border-primary group inline-flex items-center gap-3 rounded-2xl border px-4 py-3 text-sm font-medium transition-all"
      href="/help"
      target="_blank"
